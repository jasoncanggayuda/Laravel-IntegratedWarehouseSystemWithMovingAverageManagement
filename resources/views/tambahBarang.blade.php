                ...
                <!DOCTYPE html>
                    ...
                    <body>
						...
						<form action="/tambahBarang/store" method="post">
                            ...
                            <label for="kode_PO">Kode Barang</label> 
							...
							<input id="2" type="hidden" class="form-control" name="harga_satuan" placeholder="Harga Satuan" required="required" onblur="recalc()"> <br/>

                            <!-- <label for="jumlah">Jumlah</label>  -->
							<input id="3" type="hidden" class="form-control" name="jumlah" placeholder="Total Harga" required="required" readonly> <br/>
