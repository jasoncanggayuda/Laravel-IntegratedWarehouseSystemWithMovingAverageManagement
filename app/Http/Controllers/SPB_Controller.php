...
class SPB_Controller extends Controller
{
    ...
    public function ProsesSPB()
    {
        ...
        $table_spb = DB::table('valid_spb')->get();
    ...
    {
        //mengambil data dari table spb
        $table_spb = DB::table('no_valid_spb')->get();
        //mengirimkan data ke view ProsesSPB
    ...
    public function storeValidSPB(Request $request)
    {
        ...
        DB::unprepared("
        INSERT INTO `valid_spb`(`kode_spb`,`nama_barang`, `keterangan`, `qty`) VALUES 
        ('$request->kode_spb', '$request->nama_barang','$request->keterangan','$request->qty');
    ...
    public function storeNoValidSPB(Request $request)
    {
        ...
        DB::unprepared("
        INSERT INTO `no_valid_spb`(`kode_spb`, `nama_barang`, `keterangan`, `qty`) VALUES 
        ('$request->kode_spb', '$request->nama_barang','$request->keterangan','$request->qty');
    ...
    public function deleteValid($id_SPB)
    {
        // menghapus data pegawai berdasarkan id yang dipilih
        DB::table('valid_spb')->where('id_SPB',$id_SPB)->delete();
